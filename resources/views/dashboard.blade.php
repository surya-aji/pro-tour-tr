                ...
                <div class="col-xl-12 col-md-6 box-col-6 des-xl-50">
                    <div class="card profile-greeting">
                        ...
                        <div class="card-body text-center p-t-0">
                            <h3 class="font-dark">Wellcome Back, {{Auth::user()->name}}</h3>
                            <p class="font-dark">Welcome to the Family! we are glad that you are visite this
                      ...
                      <table class="table table-bordernone">
                          <tbody>
                              <tr>
                                  ...
                                  <td><a href="https://laravel.pixelstrap.com/viho/dashboard"
