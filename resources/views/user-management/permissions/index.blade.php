                        ...
                        <tbody>
                            @foreach ($permissions as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        <div class=""><i class="fa fa-spin fa-refresh"></i><code>Recently Updated
                                                by<br>{{ $item->updated_by }}</code></div>
                                    </td>
                                    <td>
                                        <span>
                                            <a href="javascript:void(0)" type="button"
                                                ...
                                                data-whatever="@getbootstrap"><i class="fa fa-pencil"></i><span>
                                                    Edit</span></a>
                                            <a class="text-danger" href="{{ route('delete-permission', $item->id) }}"><i
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="{{ route('update-permission') }}"
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="col-form-label" for="recipient-name">Display
                                                            Name:</label>
                            ...
                            <tr>
                                <td><b>~</b></td>
                                <td>{{$parents->name}} <i class="fa fa-sitemap"></i><code>parent...</code></td>
                                <td>{{$parents->display_name}}</td>
                                <td><div class=""><i class="fa fa-spin fa-refresh"></i><code>Recently Updated
                                    by<br>{{ $parents->updated_by }}</code></div></td>
                                <td>
                                    <a href="javascript:void(0)" type="button"
                                    data-bs-toggle="modal"data-bs-target="#exampleModalgetbootstrap{{ $parents->id }}"
                                    data-whatever="@getbootstrap"><i class="fa fa-pencil"></i><span>
                                        Edit</span></a>
                                <a class="text-danger" href="{{ route('delete-permission', $parents->id) }}"><i
                                        class="fa fa-trash"></i><span> Delete</span></a>
                                </td>
                            </tr>
                            @endforeach
                    ...
                    <div class="modal fade" id="exampleModalgetbootstrapCreate" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{ url('user-management/add-permission') }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                            <label class="col-form-label">Select Parent</label>
