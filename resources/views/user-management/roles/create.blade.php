...
@section('content')
    <div class="row">
        <div class="card-body">
            <form class="theme-form shadow p-3 mb-5 bg-white rounded col-sm-12" action="{{ route('create-role') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 nav-md-mt">
                        <div>
                          <label class="col-form-label pt-0" for="exampleInputEmail1">Permissions</b></label>
                        </div>
